...
if defined?(Api::V1::ApplicationController)
  class Api::V1::QuestionsController < Api::V1::ApplicationController
    ...
    # GET /api/v1/teams/:team_id/questions
    def index
    end
    ...
    # POST /api/v1/teams/:team_id/questions
    def create
      if @question.save
        render :show, status: :created, location: [:api, :v1, @question]
      else
    ...
    module StrongParameters
      ...
      def question_params
        strong_params = params.require(:question).permit(
          *permitted_fields,
          :name,
          :description,
