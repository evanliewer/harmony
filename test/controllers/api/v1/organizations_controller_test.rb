...
class Api::V1::OrganizationsControllerTest < Api::Test
  ...
  def assert_proper_object_serialization(organization_data)
    ...
    assert_equal_or_nil organization_data['address'], organization.address
    assert_equal_or_nil organization_data['website'], organization.website
  ...
  test "update" do
    ...
    put "/api/v1/organizations/#{@organization.id}", params: {
      ...
      organization: {
        ...
        website: 'Alternative String Value',
    ...
    assert_equal @organization.website, 'Alternative String Value'
